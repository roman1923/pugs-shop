...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'pugs-shop' ); ?></a>
				...
				<div class="col-md-4">
					<ul class="announcement-bar__list">
						<li>
							...
							<a href="tel: +44 555 22211" class="text-decoration-none">
								+44 555 22211
							</a>
						</li>
						<li>
							<i class="bi bi-envelope rounded-circle"></i>
							<a href="mailto: zhurakivskyy19@gmail.com" class="text-decoration-none">
								zhurakivskyy19@gmail.com
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="row">
					<div class="col-12 d-flex justify-content-center">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
							...
							<?php esc_html_e( 'Primary Menu', 'pugs-shop' ); ?>
						</button>
					</div>
